...
<div class="row dnnpane">
			<div id="LeftSidebar5" class="col-md-4 spacingTop" runat="server"></div>
			<div id="LeftSidebarOuter5" class="col-md-8 spacingTop" runat="server"></div>
		</div>

<div class="row dnnpane">
			<div id="LeftSidebarOuter6" class="col-md-8 spacingTop" runat="server"></div>
			<div id="LeftSidebar6" class="col-md-4 spacingTop" runat="server"></div>
		</div>
		<div class="row dnnpane">
