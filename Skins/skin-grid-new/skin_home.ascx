...
<section>
	...
	<div class="cms-flex__page-content-full">
	  ...
	  <div class="container">
		...
		<div class="container">
	<div class="row dnnpane">
			  <div id="midleLeftOuter2" class="col-md-3 col-sm-3 col-12 spacingTop" runat="server"></div>
			  <div id="midleLeftInner2" class="col-md-3 col-sm-3 col-12 spacingTop" runat="server"></div>
			  <div id="midleRightInner2" class="col-md-3 col-sm-3 col-12 spacingTop" runat="server"></div>
			  <div id="midleRightOuter2" class="col-md-3 col-sm-3 col-12 spacingTop" runat="server"></div>
		</div>
	</div>
		</section>
		<section>
		<div class="row dnnpane">
			<div id="LeftPane3" class="col-md-6 col-sm-6 spacingTop" runat="server"></div>
			<div id="RightPane3" class="col-md-6 col-sm-6 spacingTop" runat="server"></div>
		</div>
		</section>
	</div>
	<section>
	...
	<div class="container">
		...
		<div class="row dnnpane">
			<div id="BottomPane" class="col-md-12 col-md-6 col-sm-6 spacingTop" runat="server"></div>
		</div>
	  </div>
