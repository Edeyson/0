...
<section>
	...
	<div class="container cms-flex__page-content">
		...
		<div class="row dnnpane d-sm_net-flex">
	...
	<div class="container">
		...
		<div class="row dnnpane">
			<div id="RightSidebarOuter" class="col-md-8 spacingTop" runat="server"></div>
			<div id="RightSidebar" class="col-md-4 spacingTop" runat="server"></div>
		</div>
		<div class="row dnnpane">
			<div id="MiddlePanezero" class="col-md-12 contentPane spacingTop" runat="server"></div>
		</div>
		<div class="row dnnpane">
			<div id="LeftSidebar" class="col-md-4 spacingTop" runat="server"></div>
			<div id="LeftSidebarOuter" class="col-md-8 spacingTop" runat="server"></div>
		</div>
		<div class="row dnnpane">
...
<!-- Footer -->
<dnn:DnnCssInclude ID="swipperCss" runat="server" FilePath="/portals/1192/skins/skin-grid-new/assets/Css/swiper.css" PathNameAlias="" />
<dnn:DnnJsInclude ID="swipper" runat="server" FilePath="https://cdn.jsdelivr.net/npm/swiper@8/swiper-bundle.min.js" PathNameAlias="" />
</div>
<!-- /.SiteWrapper -->
    <script defer>        
      new Swiper(".swiper--4", {
        ...
        a11y: {
            ...
            lastSlideMessage: 'esta es la ultima diapositiva',
            paginationBulletMessage: 'Ir a diapositiva {{index}}',
            id:'sliderFluid',
            notificationClass:'swiper-notification',
            slideLabelMessage:'slider {{index}} / {{slidesLength}}'
        },
        spaceBetween: 30,
        breakpoints : {
