...
<div class="cms-flex__main"> 
	...
	<div class="cms-flex__page-content-full">
	  ...
	  <div class="container">
		...
		<div class="row dnnpane">
			<div id="LeftPane" class="col-md-6 spacingTop" runat="server"></div>
			<div id="RightPane" class="col-md-6 spacingTop" runat="server"></div>
		</div>
		<div class="row dnnpane">
			<div id="MiddlePane2" class="col-md-12 contentPane spacingTop" runat="server"></div>
		</div>
		<div class="row dnnpane">
			<div id="LeftPane2" class="col-md-6 spacingTop" runat="server"></div>
			<div id="RightPane2" class="col-md-6 spacingTop" runat="server"></div>
		</div>
		<div class="row dnnpane">
			  <div id="midleLeftOuter" class="col-md-3 spacingTop" runat="server"></div>
			  <div id="midleLeftInner" class="col-md-3 spacingTop" runat="server"></div>
			  <div id="midleRightInner" class="col-md-3 spacingTop" runat="server"></div>
			  <div id="midleRightOuter" class="col-md-3 spacingTop" runat="server"></div>
			</div>
		<div class="row dnnpane">
