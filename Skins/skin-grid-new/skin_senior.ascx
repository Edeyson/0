...
<section>
	...
	<div class="cms-flex__page-content-full">
		...
		<div class="container">
		<div class="row dnnpane">
			<div id="RightSidebarOuter" class="col-md-8 col-sm-8 spacingTop" runat="server"></div>
			<div id="RightSidebar" class="col-md-4 col-sm-4 spacingTop" runat="server"></div>
		</div>
		</div>
		</section>
		...
		<div class="container">
		<div class="row dnnpane">
			<div id="LeftSidebar" class="order-2 order-sm-1 col-md-4 spacingTop" runat="server"></div>
			<div id="LeftSidebarOuter" class="order-1 order-sm-2 col-md-8 spacingTop" runat="server"></div>
		</div>
		</div>
		</section>
		<section>
		<div class="container">
		<div class="row dnnpane">
			<div id="RightSidebarOuter2" class="col-md-8 col-sm-8 spacingTop" runat="server"></div>
			<div id="RightSidebar2" class="col-md-4 col-sm-4 spacingTop" runat="server"></div>
		</div>
		</div>
		</section>
		...
		<div class="container">
		<div class="row dnnpane">
			<div id="LeftSidebar3" class="order-2 order-sm-1 col-md-4 spacingTop" runat="server"></div>
			<div id="LeftSidebarOuter3" class="order-1 order-sm-2 col-md-8 spacingTop" runat="server"></div>
		</div>
		</div>
		</section>
		<section>
		...
		<div class="container">
			<div class="row dnnpane">
		<div id="ContentPane3" class="col-md-12 contentPane" runat="server"></div>
			</div>
		</div>
		</section>
		<div class="container">
		...
		<div class="container">
		<div class="row dnnpane">
			<div id="TopLeftOuter" class="col-md-3 spacingTop" runat="server"></div>
			<div id="TopLeftInner" class="col-md-3 spacingTop" runat="server"></div>
			<div id="TopRightInner" class="col-md-3 spacingTop" runat="server"></div>
			<div id="TopRightOuter" class="col-md-3 spacingTop" runat="server"></div>
		</div>
		</div>
	</div>
	...
	<div class="container cms-flex__page-content">
		<div class="row dnnpane">
			<div id="TopLeftSidebar" class="col-md-3 spacingTop" runat="server"></div>
			<div id="TopLeftSidebarOuter" class="col-md-9 spacingTop" runat="server"></div>
		</div>

		<div class="row dnnpane">
			<div id="TopRightSidebarOuter" class="col-md-9 spacingTop" runat="server"></div>
			<div id="TopRightSidebar" class="col-md-3 spacingTop" runat="server"></div>
		</div>
		
		<div class="row dnnpane">
			<div id="TopLeftPane" class="col-md-4 spacingTop" runat="server"></div>
			<div id="TopMiddlePane" class="col-md-4 spacingTop" runat="server"></div>
			<div id="TopRightPane" class="col-md-4 spacingTop" runat="server"></div>
		</div>
	</div>
	<div id="MiddlePaneFull" class="col-md-12 contentPane spacingTop" runat="server"></div>

	<div id="MiddlePaneFull2" class="col-md-12 contentPane spacingTop" runat="server"></div>

	<div id="MiddlePaneFull3" class="col-md-12 contentPane spacingTop" runat="server"></div>
	<section>
	<div class="container">
		<div class="row dnnpane">
			<div id="MiddlePane" class="col-md-12 contentPane spacingTop" runat="server"></div>
		</div>
		<div class="row dnnpane">
			<div id="LeftShortPane" class="col-md-3 spacingTop" runat="server"></div>
			<div id="CenterPane" class="col-md-6 spacingTop" runat="server"></div>
			<div id="RightShortPane" class="col-md-3 spacingTop" runat="server"></div>
		</div>
		<div class="row dnnpane">
			<div id="MiddlePane5" class="col-md-12 contentPane spacingTop" runat="server"></div>
		</div>
		
		<div class="row dnnpane">
			<div id="MiddlePanezero" class="col-md-12 contentPane spacingTop" runat="server"></div>
		</div>
		<div class="row dnnpane">
		...
		<div class="row dnnpane">
			<div id="LeftPane2" class="col-md-6 col-sm-6 spacingTop" runat="server"></div>
			<div id="RightPane2" class="col-md-6 col-sm-6 spacingTop" runat="server"></div>
		</div>
		<div class="row dnnpane">
	...
	<div id="MiddlePaneFull4" class="col-md-12 contentPane spacingTop" runat="server"></div>
	...
	<div class="row dnnpane">
		...
		<div class="row dnnpane">
			<div id="MiddlePane4" class="col-md-12 contentPane spacingTop" runat="server"></div>
		</div>
	</div>	
		<div id="MiddlePaneFull5" class="col-md-12 contentPane spacingTop" runat="server"></div> 
